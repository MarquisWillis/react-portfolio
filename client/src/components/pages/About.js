    ...
    return (
        <div className='container'>
            ...
            <p className='text-white'>
                ...
                Working with other collaborators on large scale projects to not only add, but improve already existing technoligies is an enticing experience that I am able to perform at my highest capacity. 
            </p>
        </div>
